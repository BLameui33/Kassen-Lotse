...
function generateWiderspruchKurPDF() {
    ...
    // ==========================================
    // 1. LOGIK: FRISTDATUM AUSLESEN / BERECHNEN
    // ==========================================
    ...
    // ==========================================
    // 2. LAYOUT: UNIFORMER BRIEFKOPF START
    // ==========================================
    doc.setFontSize(11);
    ...
    // A. RECHTER BLOCK: Haupt-Absenderblock (Oben rechts)
    ...
    // B. LINKER BLOCK: Kleine Rücksendezeile + Empfänger (Kasse)
    let leftY = margin + 15; 
    ...
    // C. DATUM: Rechtsbündig unterhalb der Blöcke
