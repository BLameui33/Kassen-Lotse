...
function generateZahnersatzBegleitschreibenPDF() {
    ...
    // Absender-Logik (Verfasser ZE oder Versicherter)
    ...
    if (verfasserIdentischZE === 'nein' && verfasserNameZE.trim() !== "") {
        ...
        // Hinweis: Adresse des Verfassers ist hier laut Vorlage nicht vorgesehen, Hauptadresse bleibt vpAdresse
    }
    ...
    // Kollisionsschutz (gleicht asymmetrische Spaltenhöhen inklusive Telefonnummer perfekt aus)
