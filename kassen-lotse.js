 ...
 *
 * Usage:
 * 1) Datei speichern unter /js/kassen-lotse.js
 * 2) <script src="/js/kassen-lotse.js" defer></script> vor <script src="paypal-buttons.js"></script>
</body> einfügen
 *
...
(function () {
  ...
  const CONFIG = {
    ...
    authorDefault: 'Kassen-Lotse Team',
    pdfFilename: 'Kassen-Lotse_Checkliste.pdf',
...
<head>
<meta charset="utf-8">
<title>Checkliste – Kassen-Lotse</title>
...
<div class="intro">Diese Checkliste stammt von Kassen-Lotse. Speichern Sie die Seite als PDF oder drucken Sie sie.</div>
